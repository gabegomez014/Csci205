...
public class EmployeeTest extends TestCase {
    ...
    public void testCalcualtePay() {
        System.out.println("Calculate Pay");
        double expResult = 384.61;  //where 20,000 is salary and 2080 is hrs/year

        assertEquals(emp.calculatePay(40), expResult, 1.0E-2);

        expResult = 5038.16;

        assertEquals(emp.calculatePay(46), expResult, 1E-2);
    }
